...
\title{Learning Report\\Por2Folios Platform Development}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author names
%
...
\IEEEcompsocitemizethanks{
	...
	E-mail: francisco.calisto@tecnico.ulisboa.pt,\protect\\
	Instituto Superior Técnico, Universidade de Lisboa.\protect\\}% <-this % stops an unwanted space}% <-this % stops an unwanted space
\thanks{Manuscript received on the June 25, 2016.}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The paper headers
\markboth{Por2Folios Platform}%
% for a single student
%{Surname}% : for a single student 
% for a Group Report 
{Sousa \MakeLowercase{\textit{et al.}}}% : for a Group Report 
%
