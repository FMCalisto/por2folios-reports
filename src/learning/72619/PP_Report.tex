...
\begin{abstract}
The goal of this report is to describe and highlight every stage on the development of a platform called Po2folios, developed during the semester. The main goal on this platform is to showcase every project and report developed during previous editions of the Portfolio III and IV classes.\end{abstract}
%
\begin{IEEEkeywords}
