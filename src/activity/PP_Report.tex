...
\begin{abstract}
This report aims to describe the learning experienced by the development team and the development process of the Por2Folios platform. This platform will hold all the projects, works and reports produced by the students enrolled in the course throughout the years.
\end{abstract}
%
\begin{IEEEkeywords}
...
Development wise, the input of new activities still needs to be standardized into the platform in order to use predefined entries and layout. This will allow the activities to correctly appear in the front-end. Furthermore, this feature is considered to be extremely important so that the correct functioning of the platform is guaranteed. To implement this, we will likely require a bigger development team.
